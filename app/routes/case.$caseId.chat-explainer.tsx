    ...
    <div className="flex flex-col h-screen w-screen">
      ...
      <div className="flex flex-col items-center space-y-8 py-12 mx-8">
        <StaticChatMessage
          ...
          isFinished={showNext}
          text={`This process has 3 steps.\n\nIn the first step, you will articulate a value for the question at hand. This usually takes around 5-10 minutes.\n\nNote: Only the values you articulate will be shared, not the chat content (although the admin will be able to see the full chat).`}
        />
        <div
          className={cn(
