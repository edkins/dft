    ...
    <div className="flex flex-col h-screen w-screen">
      ...
      <div className="grid flex-grow place-items-center space-y-8 py-12 mx-8">
        <StaticChatMessage
          ...
          text={`Here are some examples of how others have answered. Your next task is to determine which of these values you think are wisest to consider for the question at hand.\n\nSelect 2 or more responses by clicking on them.`}
        />
